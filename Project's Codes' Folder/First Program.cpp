...
{ //Defining 14th Helping Function
	...
	{	
		...
		{
			line_gap();
			cout<<"Disance between sender and receiver device in below water level can be betweemn 0km to 25900000000kms i.e 2.59 billion kms i.e. of DSN Network."<<endl;
			line_gap();
			Invalid_Statement();
		}
		else
